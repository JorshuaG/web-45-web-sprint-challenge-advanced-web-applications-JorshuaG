...
1. Explain what a token is used for.
   token are used for handling authentication and persisting authentication through session

2. What steps can you take in your web apps to keep your data secure?
   ProtectedRoutes, auhtorization requirments for api calls.

3. Describe how web servers work.
   web servers are a machine with code that handles http requests and sending information to those rrequests
